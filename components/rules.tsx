...
import { type Rule, getAllRules } from "@/data/rules";
...
function VerticalFade({ side, className = "", ...props }: { side: "top" | "bottom"; className?: string;[key: string]: any }) {
    return (
        <div
            aria-hidden
...
function HorizontalFade({ side, className = "", ...props }: { side: "left" | "right"; className?: string;[key: string]: any }) {
    return (
        <div
            aria-hidden
...
function VerticalLine({ side, className = "", ...props }: { side: "left" | "right"; className?: string;[key: string]: any }) {
    return (
        <div
            aria-hidden
                ...
                <div className="max-w-[800px] w-full mx-auto pt-20 pb-64 px-8 bg-[#111] shadow-xl border border-white/5">
                    <div className="mb-8 text-white/60 text-lg w-full">
                        <p className="leading-relaxed mb-6">
                            ...
                            Please read and follow these rules to maintain a healthy and productive environment for all members.
                        </p>
                        <a
                    ...
                    <div className="mt-12 pt-8 border-t border-white/10 text-white/50 text-sm">
                        <p>
                            Violations of these rules may result in warnings, temporary muting, or removal from the group.
                            Let's work together to keep TDC a welcoming space for all developers! 🚀
                        </p>
                    </div>
                </div>
            </div>
